...
[`LowerRequest`](#LowerRequest) 메시지에 대한 응답으로 대상 기기의 높낮이를 낮추도록 요청한 후 처리된 결과를 CLOVA에 전송합니다.
...
## LowerRequest {#LowerRequest}
스마트 침대 같은 기기를 제어할 때 사용되며, 대상 기기의 높낮이를 내리도록 CLOVA Home extension에 요청합니다. 이 요청에 대한 응답으로 [`LowerConfirmation`](#LowerConfirmation) 메시지를 사용해야 합니다.
