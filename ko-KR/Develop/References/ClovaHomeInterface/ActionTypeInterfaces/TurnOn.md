...
[`TurnOnRequest`](#TurnOnRequest) 메시지에 대한 응답으로 대상 기기를 켜도록 요청한 후 처리된 결과를 CLOVA에 전송합니다.
...
## TurnOnRequest {#TurnOnRequest}
대상 기기를 켜도록 CLOVA Home extension에 요청합니다. 이 요청에 대한 응답으로 [`TurnOnConfirmation`](#TurnOnConfirmation) 메시지를 사용해야 합니다.
