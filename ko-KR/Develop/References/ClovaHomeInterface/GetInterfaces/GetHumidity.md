...
주로 가습기와 같은 기기에서 측정된 습도 정보를 확인할 때 사용되며, 대상 기기가 측정한 습도 정보를 CLOVA Home extension에 요청합니다. 이 요청에 대한 응답으로 [`GetHumidityResponse`](#GetHumidityResponse) 메시지를 사용해야 합니다.
...
## GetHumidityResponse {#GetHumidityResponse}
[`GetHumidityRequest`](#GetHumidityRequest) 메시지에 대한 응답으로 대상 기기가 측정한 습도 정보를 CLOVA에 전송합니다.
...
| `humidity`                 | [HumidityInfoObject](/Develop/References/ClovaHomeInterface/Shared_Objects.md#HumidityInfoObject) | 현재 기기가 측정한 습도 정보를 담고 있는 객체   | 필수    |
