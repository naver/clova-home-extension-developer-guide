...
[`DecrementIntensityLevelRequest`](#DecrementIntensityLevelRequest) 메시지에 대한 응답으로 대상 기기가 압력이나 수압의 세기를 낮추도록 요청한 후 처리된 결과를 CLOVA에 전송합니다.
...
## DecrementIntensityLevelRequest {#DecrementIntensityLevelRequest}
주로 에어컨이나 온도 조절 장치와 같은 기기를 제어할 때 사용되며, 대상 기기가 지정한 값만큼 압력이나 수압의 세기를 낮추도록 CLOVA Home extension에 요청합니다. 이 요청에 대한 응답으로 [`DecrementIntensityLevelConfirmation`](#DecrementIntensityLevelConfirmation) 메시지를 사용해야 합니다.
...
| `deltaIntensity`   | [IntensityLevelInfoObject](/Develop/References/ClovaHomeInterface/Shared_Objects.md#TemperatureInfoObject) | 변경할 세기의 정보를 담고 있는 객체                            | 항상    |
