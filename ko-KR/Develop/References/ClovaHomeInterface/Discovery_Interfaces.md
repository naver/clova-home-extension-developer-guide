...
| [`DiscoverAppliancesResponse`](#DiscoverAppliancesResponse) | Response | [`DiscoverAppliancesRequest`](#DiscoverAppliancesRequest) 메시지에 대한 응답으로 사용자가 등록한 IoT 기기 목록을 CEK에 전달합니다. |
...
## DiscoverAppliancesResponse {#DiscoverAppliancesResponse}
사용자가 등록한 기기 목록을 CEK에 전달합니다. 이 메시지는 [`DiscoverAppliancesRequest`](#DiscoverAppliancesRequest) 메시지에 대한 응답으로 사용됩니다.
